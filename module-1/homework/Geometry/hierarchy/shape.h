...
public:
    ...
    virtual bool containsPoint(const Point& point) const = 0; // находитс€ ли точка внутри фигуры.
    ...
    virtual void reflex(const Line& axis) = 0; // симметрию относительно пр€мой
